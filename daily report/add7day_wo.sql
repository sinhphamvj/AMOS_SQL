...
WHERE wo_header.event_perfno_i > 0
    ...
    WHERE
        ...
        AND wo_header.state = 'O'
        AND (ac_mission.misson_config_no_i NOT IN (1001,60) OR ac_mission.misson_config_no_i IS NULL)
      ...
      AND (wo_header_more.mel_chapter NOT LIKE '25-64-01%' or wo_header_more.mel_chapter is null )
) AS WO
